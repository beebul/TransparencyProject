...
<body>
		...
		<blockquote>The admissions information set for each degree outlines a collection of information that will help you to gauge and compare study options, course admission criteria and your likely student peer cohort across multiple courses and admission options.Each admissions information set at the degree level will include a student profile for the degree and, for most degrees, an ATAR profile. An ATAR profile will not be available where there were no applicants in the secondary education applicant group for that degree.<br>
